...
def seed_database():
    ...
    if cur.fetchone()[0] == 0:
        sample_data = [
            (
                "Priya", "78901", "5678",
                "Luxury Electronics Store", "₹89,500.00", "3:45 AM IST", "international_website.com",
                "pending_review", "Automated flag: High value international transaction."
            ),
            (
                "Amit", "23456", "9012",
                "Gaming Platform Subscription", "₹12,999.00", "11:30 PM IST", "gaming_store.net",
                "pending_review", "Automated flag: Unusual merchant category."
            ),
            (
                "Neha", "34567", "3456",
                "Unknown Online Marketplace", "₹67,800.00", "1:15 AM IST", "suspicious_site.xyz",
                "pending_review", "Automated flag: Suspicious merchant domain."
            ),
            (
                "Rahul", "45678", "7890",
                "International Flight Booking", "₹1,45,000.00", "4:20 AM IST", "travel_agency.com",
                "pending_review", "Automated flag: High value travel transaction."
            ),
            (
                "Anjali", "56789", "2345",
                "Cryptocurrency Exchange", "₹2,50,000.00", "2:00 AM IST", "crypto_platform.io",
                "pending_review", "Automated flag: High risk merchant category."
            )
        ]
        cur.executemany(
            """
...
class FraudAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            You are 'Alex', a Fraud Detection Specialist at AstraFin Bank.
